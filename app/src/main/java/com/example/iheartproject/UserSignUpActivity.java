...
public class UserSignUpActivity extends AppCompatActivity {
    ...
    private EditText fullNameTbx;

    private EditText donorUserNameTbx;
    ...
    private void Login(String email, String password, String confirmPassword, String fullName, String donorUserName, DatabaseReference myRef){
        try
        {
            ...
            if (email == null || password == null || confirmPassword == null || fullName == null || donorUserName == null) {
                Toast.makeText(UserSignUpActivity.this, "Please fill in all the fields.",
...
//                                                    Toast.makeText(UserSignUpActivity.this, "User profile fail to update.",
//                                                            Toast.LENGTH_SHORT).show();
//                                                    return;
//                                                }
//                                            }
//                                        });
                                ...
                                User userObj = new User(user.getUid(), email, fullName , donorUserName, null, false);
                                ...
                                Toast.makeText(UserSignUpActivity.this, "User successfully created.",
                                        Toast.LENGTH_SHORT).show();
        ...
        catch (Exception ex)
        {
            ...
            Toast.makeText(UserSignUpActivity.this, "Exception error occurred",
                    Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fullNameTbx = (EditText) findViewById(R.id.fullName);
        donorUserNameTbx = (EditText) findViewById(R.id.donorUserName);
        ...
        signUpButton.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        fullName = fullNameTbx.getText().toString();
                        donorUserName = donorUserNameTbx.getText().toString();
