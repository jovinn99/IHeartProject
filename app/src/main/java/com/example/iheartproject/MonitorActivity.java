...
public class MonitorActivity extends AppCompatActivity {
    ...
    public class EquipmentItem{
        ...
        public EquipmentItem(String uid, MonitorActivity.Equipment eqp, String equipmentType, String brand, String model, String serialNo, Integer qty, String expiryDate )
        {
            Uid = uid;
            Equipment = eqp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        expDateTbx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                picker = new DatePickerDialog(MonitorActivity.this,
        ...
        submitButton.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        monitorType = dropdown1.getSelectedItem().toString();
                        ...
                        MonitorActivity.EquipmentItem equipment = new MonitorActivity.EquipmentItem(uuid, MonitorActivity.Equipment.Monitor,monitorType,manufacturerBrand,modelName,serialNo,quantity,currentExpiryDate);
 ...
 /*                     /*Fragment mFragment = new DiagnosticFragment();
        ...
        myRef.child("MedicalEquipment").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                List<MonitorActivity.EquipmentItem> eqpList = new ArrayList<MonitorActivity.EquipmentItem>();

                Map<String, MonitorActivity.EquipmentItem> td = (HashMap<String, MonitorActivity.EquipmentItem>) dataSnapshot.getValue();
                List<Object> tdList = new ArrayList<Object>(td.values());
                for(Object objectTd :tdList ){
                    MonitorActivity.EquipmentItem eqpItem2 = new MonitorActivity.EquipmentItem();
                    ...
                    for (Map.Entry<String,String> entry : item.entrySet()) {
                        ...
                        if(key.equals("com.example.iheartproject.Equipment"))
                            eqpItem2.Equipment = MonitorActivity.Equipment.valueOf(value);
                        if(key.equals("Qty"))
                ...
                for(MonitorActivity.EquipmentItem item: eqpList){
